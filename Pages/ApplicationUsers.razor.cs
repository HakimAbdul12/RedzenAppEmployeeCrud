...
namespace Employess.Pages
{
    public partial class ApplicationUsers
    {
        ...
        protected IEnumerable<Employess.Models.ApplicationUser> users;
        protected RadzenDataGrid<Employess.Models.ApplicationUser> grid0;
        ...
        protected async Task RowSelect(Employess.Models.ApplicationUser user)
        {
        ...
        protected async Task DeleteClick(Employess.Models.ApplicationUser user)
        {
            try
            {
